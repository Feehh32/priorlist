    ...
    <section className="relative min-h-screen md:flex justify-center px-8 md:px-0">
      ...
      <section className="max-w-3xl bg-white/80 shadow-md rounded-2xl p-8 md:absolute md:top-1/4">
        ...
        <div className="mb-8 text-secondary">
          <p className="mb-4">
            O Priolist é uma ferramenta simples e eficiente para gerenciar suas
            tarefas diárias. Organize suas prioridades, acompanhe seu progresso
            e mantenha o foco no que realmente importa.
          </p>

          <p>
            Nosso objetivo é ajudá-lo a aumentar sua produtividade e reduzir o
            estresse, proporcionando um ambiente limpo e fácil de usar para que
